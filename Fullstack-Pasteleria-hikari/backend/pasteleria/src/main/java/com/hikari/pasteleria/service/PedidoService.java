...
import com.hikari.pasteleria.repository.InventarioRepository;
import com.hikari.pasteleria.repository.OrderItemRepository;
...
public class PedidoService {
    ...
    // 🔥 MÉTODO AJUSTADO
    public List<Pedido> findPedidosByUsuario(Long usuarioId) {
